...
namespace SampleWebApplicationNLog.IntegrationTests
{
    public class LoggingTest : IClassFixture<WebApplicationFactory<Startup>>
    {
        ...
        {
            _factory = factory.WithWebHostBuilder(builder => builder.UseTestLogging(options => options.FilterByNamespace(nameof(SampleWebApplicationNLog))));

            // or
            //_factory = factory.WithWebHostBuilder(builder =>
            //    builder.ConfigureLogging(logging =>
            //        logging.AddTest(options =>
            //            options.FilterByNamespace(nameof(SampleWebApplicationNLog)))));
        }
