...
namespace MELT
{
    public class SerilogLogEntry
    {
        ...
        public string OriginalFormat => Properties.Count > 0 && Properties[Properties.Count - 1].Key == "{OriginalFormat}" && Properties[Properties.Count - 1].Value is string s ? s : Constants.NullString;
