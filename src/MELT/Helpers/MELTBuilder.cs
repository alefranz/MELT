...
namespace MELT
{
    public static class MELTBuilder
    {
        ...
        /// </summary>
        /// <returns>The test sink.</returns>
        public static ITestSink CreateTestSink() => CreateTestSink(_ => { });
        ...
        public static ITestLoggerFactory CreateLoggerFactory(Action<TestSinkOptions> configure) => new TestLoggerFactory(CreateTestSink(configure), true);
        ...
        /// <param name="configure">A delegate used to configure the <see cref="TestSinkOptions"/>.</param>
        /// <returns>The test logger factory.</returns>
        public static ITestLoggerFactory CreateLoggerFactory() => CreateLoggerFactory(_ => { });
    }
}
